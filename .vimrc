...
let g:ycm_global_ycm_extra_conf = '~/work/ponyai/.sub-repos/common/third_party/bazel-compilation-database/.ycm_extra_conf.py'
let g:github_enterprise_urls = ['https://github.corp.pony.ai']
